                ...
                for (DocumentChange documentChange : value.getDocumentChanges()) {
                    if (documentChange.getType() == DocumentChange.Type.ADDED) {
                        ...
                        if (!addedPostIds.contains(postId)) {
                            ...
                            post.setUserName(documentChange.getDocument().getString(Constants.KEY_USER_NAME));
                            post.setUserImage(documentChange.getDocument().getString(Constants.KEY_USER_IMAGE));
